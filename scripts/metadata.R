...
# For the list of projects, loads the metadata from github and reports them in a csv file
...
doStride <- function(stride, strides) {
    downloadMetadata("js", "/data/ecoop17/datasets/js", SECRETS, "peta", "pycus", stride = stride, strides = strides)
}
